...
class UpdateInstitucionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rif' => 'required|string',
            'nif' => 'required|string',
            'fecha_de_fundada' => 'required|date|max:10',
            ...
            'codigo_estadistico' => 'required|string|max:255',
            'codigo_cenae' => 'required|string|max:255',
            'codigo_circuito' => 'required|string|max:255',
            'codigo_primaria' => 'required|string|max:255',
            'codigo_electoral' => 'required|string|max:255',
            'comuna' => 'required|string|max:255',
            'zona_educativa' => 'required|string|max:255',
            'turno' => 'required|string|max:255',
            'medio' => 'required|string|max:255',
            'tipo_de_escuela' => 'required|string|max:255',
            'numero_de_aulas' => 'required|string|max:255',
            'numero_de_secciones' => 'required|string|max:255',
            'otras_aulas' => 'required|string|max:255',
