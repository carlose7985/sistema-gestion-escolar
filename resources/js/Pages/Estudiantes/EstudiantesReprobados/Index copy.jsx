...
export default function EstudiantesReprobados({
    ...
    const handleOpenRetire = (student) => {
        // Validación 1: Estudiante ya retirado

        // Validación 2: Estudiante con grado asignado
                ...
                html: `
                    <div class="space-y-3">
                        <p class="text-sm font-medium text-slate-600 dark:text-slate-300">
                            Este estudiante ya tiene un grado asignado.
                        </p>
                        <p class="text-xs text-slate-500">
                            No se puede retirar un estudiante que ya tiene grado asignado.
                        </p>
                    </div>
                `,
        ...
        if (student.contador_impresiones === 0 || student.actualizado === 0) {
            setModal((prev) => ({ ...prev, retire: false }));
            Swal.fire({
                icon: "warning",
                title: "Constancia de Reprobado Requerida",
                html: `
                   <div class="space-y-4">
                       <div class="flex items-center justify-center">
                           <div class="w-20 h-20 bg-gradient-to-br from-amber-100 to-amber-200 rounded-full flex items-center justify-center shadow-lg ring-4 ring-amber-100/50">
                       ...
                       <div class="space-y-2">
                           <p class="text-base font-bold text-slate-700 uppercase tracking-wide">
                               ${student.name} ${student.apellido}
                           </p>
                           <p class="text-sm text-slate-600 font-medium">
                               No se ha generado la <span class="text-amber-600 font-black">Constancia de Aprobado</span>
                           </p>
                           <div class="bg-amber-50 border-l-4 border-amber-500 p-3 rounded-r-lg text-left">
                               <p class="text-xs text-slate-600 font-bold uppercase tracking-wider">
                                   ⚠️ Acción requerida
                               </p>
                               <p class="text-xs text-slate-500 font-medium mt-1">
                                   Para proceder con el retiro, primero debe imprimir la constancia respectiva...
                               </p>
                           </div>
                       </div>
                   </div>
               `,
                ...
                backdrop:
                    "rgba(0,0,0,0.6) url('/img/confetti-dark.png') no-repeat center center / cover",
                customClass: {
                    popup: "border-2 border-amber-200 rounded-3xl shadow-[0_0_60px_rgba(245,158,11,0.15)] max-w-md",
                    confirmButton:
                        "px-8 py-3 text-sm font-bold tracking-widest uppercase rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 shadow-lg shadow-amber-200 transition-all duration-300",
                    title: "text-2xl font-black text-slate-800 uppercase",
        ...
        // Validar que no repruebe si tiene grado asignado
        if (periodo_escolar === "Cerrado") {
            Swal.fire({
                icon: "warning",
                ...
                html: `
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        <p class="text-sm font-medium text-slate-600 dark:text-slate-300">
                                            Solo se puede retirar estudiantes con el período escolar 
                                            <span class="font-bold text-amber-600 dark:text-amber-400">ABIERTO</span>
                                        </p>
                                        <p class="text-xs text-slate-500">
