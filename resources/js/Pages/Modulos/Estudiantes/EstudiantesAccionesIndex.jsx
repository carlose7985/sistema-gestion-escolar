...
const modules = [
    {
        title: "CONTROL DE ESTADÍSTICAS",
        subtitle: "Estadísticas mensuales",
        icon: "Wifi",
        color: "cyan",
    ...
    },
    {
        ...
        icon: "UserCheck",
        color: "fuchsia",
        route: "estudiantes.acciones.periodo.escolar.index",
    },
    {
        title: "ZONIFICACIÓN",
        subtitle: "Zonificación estudiantil",
        icon: "ShieldAlert",
        color: "lime",
        route: "estudiantes.acciones.zonificacion.index",
    },
    {
        title: "ESTUDIANTES A GRADO",
    ...
    {
        title: "REGISTRO UNISEX",
        subtitle: "Recepción de combos",
        icon: "Wallet",
        color: "fuchsia",
    ...
    {
        title: "ESTUDIANTES CONDICIONALES",
...
export default function Index() {
    return (
        <AuthenticatedLayout>
            ...
            <ViewContainer
                title="ESTUDIANTES ACCIONES GENERALES"
                subtitle="Gestiones y control de acciones"
                icon="UserCog"
                showSearch={false}
            >
                <div className="p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 h-[calc(100vh-200px)] max-h-[650px]">
                    {modules.map((mod, idx) => {
