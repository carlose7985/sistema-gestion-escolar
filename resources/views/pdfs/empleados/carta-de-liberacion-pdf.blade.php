...
<body>
    ...
    $sectionContent .= 'ejercia el cargo como personal ' . '<b><u>' . $empleado->tipo_de_personal . ' </b></u> ';
    $sectionContent .= 'con funciones de ' . '<b><u>' . $empleado->funcion_en_el_plantel . ' </b></u> ';

    $sectionContent .= 'en esta institución, y a partir de la siguiente fecha ' . '<b><u>' . $mesexacto . ' </b></u> '. ' queda';

    if ($empleado->sexo == 'M') {
    $sectionContent .= ' LIBERADO ';
    }
    if ($empleado->sexo == 'F') {
    $sectionContent .= ' LIBERADA ';
    }


    $sectionContent .= ' de sus funciones, para ejercer en la siguiente institución: <u><b>' . $destino . '</b></u>.';
