...
<body>
    ...
    $sectionContent .= ' cursa actualmente el <b><u>' . ($estudianteData->grado ?? '') . '</b></u>, de Educación Primaria en esta institución,';

    $sectionContent .= ' manteniendo un literal cualitativo de <b><u>' . ($estudianteData->apreciacion ?? '') . '</b></u>,';

    $sectionContent .= ' en el periodo escolar <b><u> ' . ($estudianteData->periodo_escolar ?? '') . '</b></u>.';
    } else {
