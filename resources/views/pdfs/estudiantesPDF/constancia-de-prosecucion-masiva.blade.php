...
<body>
    ...
    {{-- Si se va a mostrar el descriptivo después, O si no es el último alumno del lote, saltamos página --}}
    ...
    {{-- Si no es el último alumno del lote, saltamos página para el siguiente alumno --}}
