...
<head>
    ...
    <title>Estudiantes repitienteds</title>
    <style>
        @page {
...
<body>
    ...
    <div id="header">
        ...
        <table class="table-header-a" border="0">
            <tr>
                <td class="text-center text-11" width="100%"><b>ESTUDIANTES REPITIENTES</b></td>
    ...
    <div class="container">
        <table style="width: 100%;border-collapse: collapse;border:none; line-height: 0.4cm;margin-left: 0.1cm;"
            ...
            <tr>
                ...
                <td class="text-center text-12"><b>Periodo escolar</b></td>
            ...
            <tr>
                ...
                <td class="text-center">{{ $r->periodo_escolar }}</td>
            </tr>
            @endforeach
        </table>
    </div>
